...
export default function Navbar() {
    return (
        <div classNameName="big-cnt">
            ...
            <div classNameName="btn-cnt">
                <div classNameName="nav-btn"><img src={`${bckicon}`}  alt="" /></div>
                <div classNameName="nav-btn"><img src={`${fwdicon}`}  alt="" /></div>
            </div>
            <div classNameName="search-cnt">
                <div id="search-text"><textarea name="search-textarea" cols="30" rows="1" placeholder="Search here"></textarea> </div>
                <img src={`${searchicon}`} classNameName='search-icon' alt="" />
            </div>
            <div classNameName="right-cnt">Project SLACK</div>
